...
GCC_VERSION="14.2.0" # Adjust as needed
...
function create_symlinks {
	...
	if [ -d "${RPI_ROOTFS_BASE_ABS_PATH}/usr/include/asm" ]; then
		...
		ln -sf ${RPI_ROOTFS_BASE_ABS_PATH}/usr/include/${GCC_PREFIX}/asm/* ${RPI_ROOTFS_BASE_ABS_PATH}/usr/include/asm/
	else
		ln -sf -r ${RPI_ROOTFS_BASE_ABS_PATH}/usr/include/${GCC_PREFIX}/asm ${RPI_ROOTFS_BASE_ABS_PATH}/usr/include
	fi
	if [ -d "${RPI_ROOTFS_BASE_ABS_PATH}/usr/include/gnu" ]; then
		sudo chmod 777 ${RPI_ROOTFS_BASE_ABS_PATH}/usr/include/gnu
		ln -sf ${RPI_ROOTFS_BASE_ABS_PATH}/usr/include/${GCC_PREFIX}/gnu/* ${RPI_ROOTFS_BASE_ABS_PATH}/usr/include/gnu/
	else
		ln -sf -r ${RPI_ROOTFS_BASE_ABS_PATH}/usr/include/${GCC_PREFIX}/gnu ${RPI_ROOTFS_BASE_ABS_PATH}/usr/include
	fi
	if [ -d "${RPI_ROOTFS_BASE_ABS_PATH}/usr/include/bits" ]; then
		sudo chmod 777 ${RPI_ROOTFS_BASE_ABS_PATH}/usr/include/bits
		ln -sf ${RPI_ROOTFS_BASE_ABS_PATH}/usr/include/${GCC_PREFIX}/bits/* ${RPI_ROOTFS_BASE_ABS_PATH}/usr/include/bits/
	else
		ln -sf -r ${RPI_ROOTFS_BASE_ABS_PATH}/usr/include/${GCC_PREFIX}/bits ${RPI_ROOTFS_BASE_ABS_PATH}/usr/include
	fi
	if [ -d "${RPI_ROOTFS_BASE_ABS_PATH}/usr/include/sys" ]; then
		sudo chmod 777 ${RPI_ROOTFS_BASE_ABS_PATH}/usr/include/sys
		ln -sf ${RPI_ROOTFS_BASE_ABS_PATH}/usr/include/${GCC_PREFIX}/sys/* ${RPI_ROOTFS_BASE_ABS_PATH}/usr/include/sys/
	else
		ln -sf -r ${RPI_ROOTFS_BASE_ABS_PATH}/usr/include/${GCC_PREFIX}/sys ${RPI_ROOTFS_BASE_ABS_PATH}/usr/include
	fi
	if [ -d "${RPI_ROOTFS_BASE_ABS_PATH}/usr/include/openssl" ]; then
		sudo chmod 777 ${RPI_ROOTFS_BASE_ABS_PATH}/usr/include/openssl
		ln -sf ${RPI_ROOTFS_BASE_ABS_PATH}/usr/include/${GCC_PREFIX}/openssl/* ${RPI_ROOTFS_BASE_ABS_PATH}/usr/include/openssl/
	else
	...
	ln -sf ${RPI_ROOTFS_BASE_ABS_PATH}/usr/lib64/${GCC_PREFIX}/crti.o ${RPI_ROOTFS_BASE_ABS_PATH}/usr/lib64/crti.o
}
